...
-   @guyHistoryBiologicalEffects2003
...
-   A short historical summary of EMF research by EMF:data [-@EMFDataEmfdataorg], states:
...
- Kostoff and Lau [-@kostoffModifiedHealthEffects2017] highlights the that PubMed (MEDLINE) has **MeSH terms**, which are unique keywords:
...
Also, note that Kostoff and Lau [-@kostoffModifiedHealthEffects2017] highlights the that Web of Science has *"has the capability for citation linkages (references, citing papers, papers that share at least one reference)"*:
